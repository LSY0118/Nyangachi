                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_NYANGACHIPROJECT, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_NYANGACHIPROJECT));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_NYANGACHIPROJECT));
...
{
	static POINT deltapos;
	static HBITMAP backBitmap = NULL, hOldBitmap;
	static HBITMAP hBit, hBit1, hBit2;
	static HDC hdc, backMemDC, MemDC;
	static thread *th;
	PAINTSTRUCT ps;
	switch (message)
	{
