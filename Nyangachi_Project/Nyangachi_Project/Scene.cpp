...
void CScene::ContainObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, CPlayer* pPlayer)
{
	for (int i = 0; i < m_nShaders; i++)
	{
		m_pShaders[i].ContainObjects(pd3dDevice, pd3dCommandList, pPlayer);
	}
}
...
void CLoginScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList* pd3dCommnadList)
{
	D3D12_ROOT_SIGNATURE_DESC d3dRootSignatureDesc;
	::ZeroMemory(&d3dRootSignatureDesc, sizeof(D3D12_ROOT_SIGNATURE_DESC));
...
bool CLoginScene::ProcessInput(UCHAR* pKeyBuffer)
{
	return(false);
}

void CLoginScene::AnimateObjects(float fTimeElapsed)
{
}

void CLoginScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera* pCamera)
{
...
void CInGameScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList* pd3dCommnadList)
{
	D3D12_ROOT_SIGNATURE_DESC d3dRootSignatureDesc;
	::ZeroMemory(&d3dRootSignatureDesc, sizeof(D3D12_ROOT_SIGNATURE_DESC));
	d3dRootSignatureDesc.NumParameters = 0;
...
bool CInGameScene::ProcessInput(UCHAR* pKeyBuffer)
{
	return false;
}
...
void CInGameScene::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera* pCamera)
{
